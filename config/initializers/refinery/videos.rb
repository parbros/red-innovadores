Refinery::Videos.configure do |config|
    ...
    # config.dragonfly_secret = 67a26ed4d6b3d254e27617d0be01a5d511b75be4d4e8c88a
    # If you decide to trust file extensions replace :ext below with :format
    # config.dragonfly_url_format = /system/videos/:job/:basename.:format
    # config.datastore_root_path = /Users/jparbros/repositories/red_innovadores/public/system/refinery/videos
